 ...
 *
 * Refers to keys and certificates found in smcb-certificates.p12 testing keystore
 */
object SMCBTokenHelper {
  private val keystoreService = KeystoreServiceTest.objectUnderTest
  private val privateKey = keystoreService.getPrivateKey(CRT_GEMATIK_LEAF)
  val leafCertificate = keystoreService.getCertificate(CRT_GEMATIK_LEAF)
  private val publicKey = leafCertificate.publicKey!!
